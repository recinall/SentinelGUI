...
class BasemapDownloader:
    ...
    @staticmethod
    def download_basemap(bbox, zoom, source='esri', output_path=None, target_width=None, target_height=None, target_transform=None):
        ...
        if target_width and target_height and target_transform:
            ...
            if output_path:
                ...
                bottom_right_lat, bottom_right_lon = BasemapDownloader.num2deg(x_max + 1, y_max + 1, zoom)
